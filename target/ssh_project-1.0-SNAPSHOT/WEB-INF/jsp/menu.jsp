	...
	<div class="topNav clearfix">
		<ul>
			...
			<li id="headerLogin" class="headerLogin" style="display: list-item;">
				<a href="${ pageContext.request.contextPath }/user_login.action">登录</a>|</li>
...
<div class="span24">
	<ul class="mainNav">
		...
		<%--遍历传过来的Session中的一级分类数据--%>
		<s:iterator var="c" value="#session.list">
			<li><a href="${ pageContext.request.contextPath }/product_getProductsByCid.action?cid=<s:property value="#c.cid"/>&page=1"><s:property value="#c.cname"/></a> |</li>
		</s:iterator>
