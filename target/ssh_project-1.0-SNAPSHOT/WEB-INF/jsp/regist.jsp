...
<head>
    ...
    <script>
        ...
        function checkUsername() {
            ...
            // 3.打开连接
            xhr.open("GET", "${pageContext.request.contextPath}/user_findUserByName.action?username=" + username, true);
            // 4.发送
            xhr.send(null);
        }
                ...
                <form id="registerForm" action="${ pageContext.request.contextPath }/user_regist.action" method="post"
                    ...
                    <table>
                        ...
                        <tr>
                            ...
                            <td>
                                <input id="repassword" type="password"  class="text" maxlength="20"
                                       autocomplete="off"/>
                            </td>
                        </tr>
                        <tr>
                        ...
                        <%--<tr>
                            ...
                            <td>
										<span class="fieldSet">
											<input type="text" id="checkcode"  class="text captcha"
